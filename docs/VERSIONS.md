...
|---|---|---|---|
| OpenMRS core (platform) | **2.7.9** | https://api.github.com/repos/openmrs/openmrs-core/tags (tag `2.7.9`); release artifact confirmed at https://mavenrepo.openmrs.org/public/org/openmrs/web/openmrs-webapp/2.7.9/openmrs-webapp-2.7.9.war (HTTP 200, ~110 MB) | Latest 2.7.x patch. GitHub `releases/latest` still shows 2.7.6 (2025-09-12); 2.7.7–2.7.9 exist as tags + Maven artifacts only. Latest overall core release is 2.8.7 (used by RefApp 3.7.0 — see §2). |
